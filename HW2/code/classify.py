...
def train(instances, algorithm, learning_rate, iterations, pegasos_lambda):
...
def main():
    ...
    if args.mode.lower() == "train":
        ...
        # Train the model.
        predictor = train(instances, args.algorithm, args.online_learning_rate, args.online_training_iterations, args.pegasos_lambda)
        try:
