...
class Test:
    #algorithms = {"perceptron" : 0, "averaged_perceptron" : 0, "margin_perceptron" : 0, "pegasos" : 0, "knn" : 1, "distance_knn" : 1}
    algorithms = {"adaboost" : 1}
    #bin_datasets = ["easy", "bio", "finance", "vision"]
    bin_datasets = ["easy"]
    mc_datasets = []
