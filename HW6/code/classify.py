...
from PerceptronAlgos import Perceptron, AvgPerceptron, MCPerceptron
...
def train(instances, algorithm, learning_rate, iterations):
    ...
    if (algorithm == "mc_perceptron"):
        predictor = MCPerceptron(instances, iterations)
        return predictor
